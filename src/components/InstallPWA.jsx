    ...
    <section className="bg-[#f7f4ee] py-16 px-4">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-gray-500 text-sm mb-12 max-w-md mx-auto">
          Install Gona directly from your browser — no app store needed. Works
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 text-left">
            <div className="flex items-center gap-3 mb-5">
              <div className="w-7 h-7 rounded-xl flex items-center justify-center text-xl">
                <img src="/images/android.svg" alt="Android Icon" />
              </div>
            ...
            <ol className="flex flex-col gap-4">
              {[
                {
                  step: "1",
                  text: "Open Gona in Chrome and tap the menu (⋮) at the top right",
                },
                { step: "2", text: 'Tap "Add to Home Screen"' },
                {
                  step: "3",
                  text: 'Tap "Add" to confirm — Gona appears on your home screen!',
                },
              ].map((item) => (
                <li key={item.step} className="flex items-start gap-3">
                  <span className="w-5 h-5 rounded-full bg-green-900 text-white text-xs font-bold flex items-center justify-center flex-shrink-0 mt-0.5">
                    {item.step}
                  </span>
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 text-left">
            ...
            <ol className="flex flex-col gap-4">
              {[
                {
                  step: "1",
                  text: "Open Gona in Safari and tap the Share button (□↑) at the bottom",
                },
                { step: "2", text: 'Scroll down and tap "Add to Home Screen"' },
                {
                  step: "3",
                  text: 'Tap "Add" — Gona is now on your home screen!',
                },
              ].map((item) => (
                <li key={item.step} className="flex items-start gap-3">
                  <span className="w-5 h-5 rounded-full bg-green-900 text-white text-xs font-bold flex items-center justify-center flex-shrink-0 mt-0.5">
        ...
        <div className="inline-flex items-center gap-2 bg-green-900 text-white text-sm font-medium px-5 py-3 rounded-xl">
